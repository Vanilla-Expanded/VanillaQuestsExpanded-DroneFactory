...
{
    public class GenStep_DroneScrapyard : GenStep_Site
    {
        public override void Generate(Map map, GenStepParams parms)
        {
            var rects = BuildStructure(map, parms);
            var questPart = map.Parent.GetAssociatedPart<QuestPart_AllDronesDefeated>();
            ...
            if (pawns.Any()) LordMaker.MakeNewLord(map.ParentFaction, new LordJob_DefendPoint(map.Center), map, pawns);
        }
    }
}
